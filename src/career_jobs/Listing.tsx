...
import API_URL, { CAREERJOB_TITLE } from "../utils/config";
...
const Listing: React.FC = () => {
  const [results, setResults] = useState<CareerJob[]>([]);
  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h4 className="fw-semibold">{CAREERJOB_TITLE}s</h4>
        <div>
          <NavLink to="/tags/create" className="btn btn-primary btn-sm me-2">
            <i className="fa-solid fa-plus"></i> Add New {CAREERJOB_TITLE}
          </NavLink>
        </div>
      </div>
