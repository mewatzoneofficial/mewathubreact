...
import API_URL, { CAREERAPPLICATION_TITLE } from "../utils/config";
...
interface FetchResponse {
  data: {
    responseData: CareerApplication[];
    page: number;
    totalPages: number;
    total: number;
  };
...
const Listing: React.FC = () => {
  const [results, setResults] = useState<CareerApplication[]>([]);
  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h4 className="fw-semibold">{CAREERAPPLICATION_TITLE}</h4>
        <div>
          <NavLink to="/tags/create" className="btn btn-primary btn-sm me-2">
            <i className="fa-solid fa-plus"></i> Add New {CAREERAPPLICATION_TITLE}
          </NavLink>
        </div>
      </div>
