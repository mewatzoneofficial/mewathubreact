...
import API_URL, { PACKAGE_TITLE } from "../utils/config";
...
const Listing: React.FC = () => {
  ...
  const fetchRecords = async (pageNumber = 1) => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}packages?${queryParams.toString()}`);
  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h4 className="fw-semibold">{PACKAGE_TITLE}s</h4>
        <div>
          <NavLink to="/packages/create" className="btn btn-primary btn-sm me-2">
            <i className="fa-solid fa-plus"></i> Add New {PACKAGE_TITLE}
          </NavLink>
        </div>
      </div>
                    ...
                    <tr key={result.packID}>
                      ...
                      <td className="text-right">
                        ...
                        <button
                          ...
                          onClick={() => handleDelete(result.packID)}
                        >
                          Delete
                        </button>
                      </td>
